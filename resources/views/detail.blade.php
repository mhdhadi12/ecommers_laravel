...
<body>
    ...
    // ->where('id',$id)
    // ->first();
    $rec = DB::table('stoks')->where('id', $id)->first();
    ?>
    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <form method="POST" action="{{ url('cart') }}" class="h-100 bg-light p-30">
                    @csrf

                    <input type="hidden" name="stok_id" value="{{ $rec->id }}">
                    <h3>{{ $rec->nama }}e</h3>
                    ...
                    <h3 class="font-weight-semi-bold mb-4">Rp {{ number_format($rec->hargajual) }}</h3>
                    <p class="mb-4">{{ $rec->deskripsi }}</p>
                    <div class="d-flex mb-3">
