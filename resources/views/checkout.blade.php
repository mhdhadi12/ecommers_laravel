...
<body>
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-lg-8">
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label>No Hp</label>
                            <input class="form-control" type="text" placeholder="+123 456 789" disabled
                                value="{{ $user->no_hp }}">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Alamat</label>
                            <input class="form-control" type="text" placeholder="123 Street" disabled
                                value="{{ $user->alamat }}">
                        </div>
                    </div>
                </div>
            ...
            <form action="{{ route('checkout.store') }}" method="POST" class="mb-5" enctype="multipart/form-data"
                class="col-lg-4">
                @csrf
                    ...
                    <div class="border-bottom">
                        ...
                        @foreach ($carts as $cart)
                            <div class="d-flex justify-content-between">
                                <p style="text-transform: capitalize">{{ $cart->stok->nama }} ({{ $cart->size }})</p>
                                <p>Rp. {{ number_format($cart->stok->hargajual) }}</p>
                            </div>

                            <input type="hidden" name="carts_id[]" value="{{ $cart->id }}">
                            <input type="hidden" name="stok_id[]" value="{{ $cart->stok->id }}">

                            @php
                                $subtotal += $cart->stok->hargajual;
                            @endphp
                        @endforeach
                    </div>
                        ...
                        <div class="form-group mb-4">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment" id="banktransfer"
                                    checked>
                                <label class="custom-control-label" for="banktransfer">Proof of Transfer</label>
                            </div>
