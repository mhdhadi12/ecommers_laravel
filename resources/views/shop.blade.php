                    ...
                    @foreach ($rec as $key => $value)
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div id="product-carousel{{ $key }}" class="carousel slide"
                                    data-ride="carousel">
                                    <div class="carousel-inner bg-light">
                                        @foreach (explode(',', $value->foto) as $index => $image)
                                            <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                                <img class="w-100 h-100" src="{{ url('path/produk/' . $image) }}"
                                                    alt="Product Image">
                                            </div>
                                        @endforeach
                                    </div>
                                    <a class="carousel-control-prev" href="#product-carousel{{ $key }}"
                                        role="button" data-slide="prev">
                                        <i class="fa fa-2x fa-angle-left text-dark"></i>
                                    </a>
                                    <a class="carousel-control-next" href="#product-carousel{{ $key }}"
                                ...
                                <div class="product-action">
                                    ...
                                    <a class="btn btn-outline-dark btn-square"
                                        href="{{ url('product/' . $value->id) }}"><i class="fa fa-search"></i></a>
                                </div>
                                <div class="text-center py-4">
                                    <a class="h6 text-decoration-none text-truncate"
                                        href="{{ url('product/' . $value->id) }}">{{ $value->nama }}</a>
                                    <div class="d-flex align-items-center justify-content-center mt-2">
                                        <h5>Rp {{ number_format($value->hargajual) }}</h5>
                                        <h6 class="text-muted ml-2">
                                            <del>Rp {{ number_format($value->hargajual) }}</del>
                                        </h6>
                                    </div>
