        ...
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    @php
                        $value = DB::table('carts')
                            ->leftjoin('stoks', 'stoks.id', '=', 'carts.stok_id')
                            ->select('carts.*', 'stoks.nama As namabarang', 'stoks.foto', 'stoks.hargajual')
                            ->get();
                    ...
                    <tbody class="align-middle">
                        @foreach ($value as $item)
                            @php
                                $total += $item->hargajual * $item->quantity;
                            @endphp
                            <tr>
                                ...
                                <td class="align-middle">
                                    @foreach (explode(',', $item->foto) as $i => $image)
                                        @php
                                            $i += 1;
                                        @endphp
                                        @if ($i == 1)
                                ...
                                <td class="align-middle">Rp {{ number_format($item->hargajual) }}</td>
                                <td class="align-middle">
                                    <div class="input-group quantity mx-auto" style="width: 100px;">
                                        ...
                                        <input type="text"
                                            class="form-control form-control-sm bg-secondary input-quantity border-0 text-center"
                                            value="{{ $item->quantity }}">
                                        {{-- <div class="input-group-btn">
                                ...
                                <td class="align-middle">Rp. {{ number_format($item->hargajual * $item->quantity) }}
                                </td>
                                <td class="align-middle">
